...
<template>
  <div class="w-full flex justify-center px-4">
    <div class="w-full max-w-7xl py-10">
      <!-- Título principal -->
      <h1 class="text-5xl font-extrabold text-yellow-800 mb-10">Frutal</h1>

      <!-- Bloques de cada producto -->
      <div v-for="(item, index) in store.frutales" :key="item.title" :class="index !== 0 ? 'border-t border-yellow-200 pt-6' : ''" class="pb-6">
        <!-- Nombre y Precio -->
